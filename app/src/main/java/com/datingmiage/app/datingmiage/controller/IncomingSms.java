...
public class IncomingSms extends BroadcastReceiver {
            ...
            if (bundle != null) {
                ...
                for (int i = 0; i < pdusObj.length; i++) {
                    ...
                    if (message.contains("propose")) {
                        redirectionManager(context, phoneNumber, message, "ask");
                    } else if (message.contains("accepte")) {
    ...
    public void redirectionManager(Context context, String phoneNumber, String message, String type) {
    ...
    public void notificationManager(Context c, PendingIntent i, String phoneNumber) {
